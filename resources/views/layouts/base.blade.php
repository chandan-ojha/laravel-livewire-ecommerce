...
<head>
    ...
    <title>Home</title>
    <link rel="shortcut icon" type="image/x-icon" href="assets/images/sheba_favicon.png">
    <link
                ...
                <div class="topbar-menu-area">
                    <div class="container">
                        <div class="topbar-menu left-menu">
                            <ul>
                                <li class="menu-item">
                                    <a title="Hotline: 01764805692" href="#"><span
                                            class="icon label-before fa fa-mobile"></span>Hotline: 01764805692</a>
                                </li>
                            </ul>
                        </div>
                                                ...
                                                <ul class="submenu curency">
                                                    ...
                                                    <li class="menu-item">
                                                        <a title="Manage Home Slider"
                                                            href="{{ route('admin.homeslider') }}">Manage
                                                            Home Slider</a>
                                                    </li>
                        ...
                        <div class="mid-section main-info-area">
                            ...
                            <div class="wrap-logo-top left-section">
                                <a href="/" class="link-to-home"><img
                                        src="{{ asset('assets/images/seba_today_logo.png') }}" alt="mercado"></a>
                            </div>
